(() => {
  ...
  zh: {
    ...
    'nav.collab': '指挥家', 'nav.token': '用量', 'nav.roles': '角色',
    ...
    'modal.addRole': '新增角色', 'modal.editRole': '编辑角色',
    ...
    'pq.gaToken': '获取 Token', 'pq.gaTokenDesc': '订阅后自动写入模型配置',
    ...
    'page.roles.title': '角色管理', 'page.roles.sub': '创建并维护角色提示词；启用时只影响当前会话。',
    'role.add': '新增角色', 'role.currentSession': '当前会话角色', 'role.noSession': '请先打开或新建一个会话',
    'role.off': '关闭角色', 'role.clearContext': '切换后清空旧模型上下文', 'role.empty': '暂无角色，点击右上角新增。',
    'role.builtin': '内置', 'role.active': '当前启用', 'role.available': '可用', 'role.use': '启用',
    'role.name': '角色名', 'role.namePh': '例如 release_manager 或 发布经理', 'role.prompt': '角色提示词',
    'role.promptPh': '写入这个角色需要遵循的规则，不必复制全局系统提示词。',
    'role.applied': '已启用角色：{name}', 'role.disabled': '已关闭当前会话角色',
    'role.sessionBusy': '当前任务运行中，请停止后再切换角色', 'role.savedAndUpdated': '已保存并更新使用该角色的会话',
    'role.deletedAndDisabled': '角色已删除，并已从相关会话关闭',
    'err.roleLoad': '加载角色失败', 'err.roleSave': '保存角色失败', 'err.roleDelete': '删除角色失败',
    'err.roleSwitch': '切换角色失败', 'err.roleRequired': '请填写角色名和角色提示词',
    'confirm.roleDelete': '确定删除角色「{name}」？使用该角色的会话将自动关闭角色提示词。',
    ...
    'slash.help': '可用命令：\n/new 新会话  /clear 清屏  /stop 停止  /role list|<角色名>|off [--clear] 切换角色（清空模型上下文）  /settings 设置',
    'slash.unknown': '未知命令',
  ...
  en: {
    ...
    'nav.collab': 'Conductor', 'nav.token': 'Usage', 'nav.roles': 'Roles',
    ...
    'modal.addRole': 'Add role', 'modal.editRole': 'Edit role',
    ...
    'pq.gaToken': 'Get Token', 'pq.gaTokenDesc': 'Subscribe — config is written automatically',
    ...
    'page.roles.title': 'Role management', 'page.roles.sub': 'Create and maintain role prompts. Applying a role affects only the current session.',
    'role.add': 'Add role', 'role.currentSession': 'Current session role', 'role.noSession': 'Open or create a session first',
    'role.off': 'Turn off role', 'role.clearContext': 'Clear previous model context after switching', 'role.empty': 'No roles yet. Add one above.',
    'role.builtin': 'Built-in', 'role.active': 'Active', 'role.available': 'Available', 'role.use': 'Use',
    'role.name': 'Role name', 'role.namePh': 'For example, release_manager', 'role.prompt': 'Role prompt',
    'role.promptPh': 'Write rules for this role. You do not need to copy the global system prompt.',
    'role.applied': 'Role enabled: {name}', 'role.disabled': 'Current session role turned off',
    'role.sessionBusy': 'Stop the running task before switching roles', 'role.savedAndUpdated': 'Saved and updated sessions using this role',
    'role.deletedAndDisabled': 'Role deleted and disabled for affected sessions',
    'err.roleLoad': 'Could not load roles', 'err.roleSave': 'Could not save role', 'err.roleDelete': 'Could not delete role',
    'err.roleSwitch': 'Could not switch role', 'err.roleRequired': 'Enter a role name and prompt',
    'confirm.roleDelete': 'Delete role "{name}"? It will be turned off for sessions using it.',
    ...
    'slash.help': 'Commands:\n/new new chat  /clear clear  /stop stop  /role list|<name>|off [--clear] switch role (clears model context)  /settings settings',
